package com.ankamagames.dofus.logic.game.fight.frames.Preview
{
   ...
   public class SpellEffectTranslator extends HaxeSpellEffect
   {
      ...
      public static function fromWeapon(effect:EffectInstance, weapon:WeaponWrapper, isCritical:Boolean) : SpellEffectTranslator
      {
         ...
         return new SpellEffectTranslator(DamagePreview.WEAPON_EFFECTS_INDEX++,1,effect.order,effect.effectId,param0,param1,param2,effect.duration,isCritical,effect.triggers || "I",zone,"A,g",effect.random,effect.group,effect.dispellable == EffectInstance.IS_DISPELLABLE,effect.delay,effect.category);
      }
