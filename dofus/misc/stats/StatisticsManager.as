package com.ankamagames.dofus.misc.stats
{
   ...
   public class StatisticsManager extends EventDispatcher implements IDestroyable
   {
      ...
      {
         if(!this._dataStoreType || this._dataStoreType.category != "statistics")
         {
            this._dataStoreType = new DataStoreType("statistics",true,DataStoreEnum.LOCATION_LOCAL,DataStoreEnum.BIND_COMPUTER);
         }
      }
