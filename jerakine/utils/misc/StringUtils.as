      ...
      public static function formatArray(data:Array, header:Array = null) : String
      {
         ...
         if(i is String || header)
         {
            ...
            for(i in row)
            {
               ...
               headerLine.push(lenIndex + "                                                                                                               ".substr(0,length[lenIndex] - lenIndex.length));
               headerSubLine.push("---------------------------------------------------------------------------------------------------------------".substr(0,length[lenIndex]));
            }
            result.push(headerLine.join(" | "));
            result.push(headerSubLine.join("-+-"));
         }
         for each(row in data)
         {
            line = [];
            for(i in row)
            {
               str = row[i];
               lenIndex = !!header ? header[i] : i;
               line.push(str + "                                                                                                               ".substr(0,length[lenIndex] - String(str).length));
            }
